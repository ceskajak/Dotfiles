# Catppuccin Macchiato Theme (for zsh-syntax-highlighting), pink accent
# Sourced from ~/.zshrc — chezmoi-managed, see [[dotfiles]].
# Mauve accent slots (back-quoted-argument, history-expansion) redirected to
# pink #f5bde6, matching the fleet-wide pink-accent treatment already applied
# to tmux/i3/GNOME (2026-07-16). Everything else is upstream catppuccin/zsh-
# syntax-highlighting's stock Macchiato role mapping, unmodified.
...
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]='fg=#f5bde6'
## Keywords
## Built ins
...
ZSH_HIGHLIGHT_STYLES[history-expansion]='fg=#f5bde6'
